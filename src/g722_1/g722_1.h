...
#if defined(LIBG722_1_EXPORTS)
#define G722_1_DECLARE(type)            __declspec(dllexport) type __stdcall
#define G722_1_DECLARE_NONSTD(type)     __declspec(dllexport) type __cdecl
#define G722_1_DECLARE_DATA             __declspec(dllexport)
#else
#define G722_1_DECLARE(type)            __declspec(dllimport) type __stdcall
#define G722_1_DECLARE_NONSTD(type)     __declspec(dllimport) type __cdecl
#define G722_1_DECLARE_DATA             __declspec(dllimport)
#endif
#elif defined(G722_1_USE_EXPORT_CAPABILITY)  &&  (defined(__GNUC__)  ||  defined(__SUNCC__))
#define G722_1_DECLARE(type)            __attribute__((visibility("default"))) type
#define G722_1_DECLARE_NONSTD(type)     __attribute__((visibility("default"))) type
#define G722_1_DECLARE_DATA             __attribute__((visibility("default")))
#else
#define G722_1_DECLARE(type)            /**/ type
#define G722_1_DECLARE_NONSTD(type)     /**/ type
#define G722_1_DECLARE_DATA             /**/
#endif
...
G722_1_DECLARE(int) g722_1_encode(g722_1_encode_state_t *s, uint8_t g722_1_data[], const int16_t amp[], int len);
...
G722_1_DECLARE(int) g722_1_encode_set_rate(g722_1_encode_state_t *s, int bit_rate);
...
G722_1_DECLARE(g722_1_encode_state_t *) g722_1_encode_init(g722_1_encode_state_t *s, int bit_rate, int sample_rate);

/*! Release a G.722.1 encode context.
    \param s The G.722.1 encode context.
    \return 0. */
G722_1_DECLARE(int) g722_1_encode_release(g722_1_encode_state_t *s);
...
G722_1_DECLARE(int) g722_1_decode(g722_1_decode_state_t *s, int16_t amp[], const uint8_t g722_1_data[], int len);
...
/*! Produce linear PCM data to fill in where received G.722.1 data is missing.
    ...
    \param len
    \return The number of samples returned. */
G722_1_DECLARE(int) g722_1_fillin(g722_1_decode_state_t *s, int16_t amp[], const uint8_t g722_1_data[], int len);
...
/*! Change the bit rate for an G.722.1 decode context.
    ...
    \param bit_rate The required bit rate for the G.722.1 data.
           The valid rates are 48000, 32000 and 24000.
    \return 0 for OK, or -1 for a bad parameter. */
G722_1_DECLARE(int) g722_1_decode_set_rate(g722_1_decode_state_t *s, int bit_rate);
...
G722_1_DECLARE(g722_1_decode_state_t *) g722_1_decode_init(g722_1_decode_state_t *s, int bit_rate, int sample_rate);

/*! Release a G.722.1 decode context.
    \param s The G.722.1 decode context.
    \return 0. */
G722_1_DECLARE(int) g722_1_decode_release(g722_1_decode_state_t *s);
